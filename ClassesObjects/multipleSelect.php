<h1>#2: Multiple Select Field Objects
Expand the user registration form with multiple select fields to collect more data.</h1>
<?php
...
class Select
  ...
  //If form not submitted, display form.
    ...
    ?>
        ...
        <form method="post" action="/php-exercises/CorePHP/ClassesObjects/multipleSelect.php">
        <p>Name:<br />
